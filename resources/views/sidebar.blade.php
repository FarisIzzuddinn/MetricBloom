    ...
    @can('Manage Institution')
        <li class="list-group-item">
            <a href="{{ url('institutions') }}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-building me-3" viewBox="0 0 16 16">
    ...
    @can('view permissions')
        <li class="list-group-item">
            <a href="{{ url('permissions') }}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-key me-3" viewBox="0 0 16 16">
    ...
    @can('view roles')
        <li class="list-group-item">
            <a href="{{ url('roles') }}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-badge me-3" viewBox="0 0 16 16">
    ...
    @can('view users')
        <li class="list-group-item">
            <a href="{{ url('users') }}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-people me-3" viewBox="0 0 16 16">
