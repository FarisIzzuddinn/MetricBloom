<button class="btn btn-sm btn-warning me-2" onclick="setEditModal('{{ $tera->teras }}', '{{ route('teras.update', $tera->id) }}')" data-bs-toggle="modal" data-bs-target="#editModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="editForm" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="teras" class="form-label">Nama Teras</label>
