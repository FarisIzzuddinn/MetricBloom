        ...
        <div class="col-md-3">
            <div class="card mb-1 bg-success rounded-3 shadow-sm hover-shadow" data-aos="fade-up">
                <div class="card-body text-white">
                    ...
                    <h2 class="display-4">{{ $addKpis->where('status', 'achieved')->count() }}</h2>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card mb-1 bg-warning rounded-3 shadow-sm hover-shadow" data-aos="fade-up">
                <div class="card-body text-white">
                    ...
                    <h2 class="display-4">{{ $addKpis->where('status', 'pending')->count() }}</h2>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card mb-1 bg-danger rounded-3 shadow-sm hover-shadow" data-aos="fade-up">
                <div class="card-body text-white">
                    ...
                    <h2 class="display-4">{{ $addKpis->where('status', 'not achieved')->count() }}</h2>
                </div>
            </div>
        </div>
    </div>
